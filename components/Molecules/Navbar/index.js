  ...
  return (
    <nav className='navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row'>
      <div className='text-center navbar-brand-wrapper d-flex align-items-center justify-content-center'>
        <Link href='/' className='navbar-brand brand-logo mr-5'>
          <Image src='/images/logo.svg' width={365} height={90} className='mr-2' alt='logo' />
        </Link>
        <Link href='/' className='navbar-brand brand-logo-mini'>
          {/* idth="90" height="73" */}
          <Image src='/images/logo-mini.svg' width={90} height={73} alt='logo' />
        </Link>
      </div>
      <div className='navbar-menu-wrapper d-flex align-items-center justify-content-end'>
        ...
        <ul className='navbar-nav navbar-nav-right'>
          ...
          <li className={`nav-item nav-profile dropdown ${isDropdownOpen ? 'show' : ''}`}>
            <a className='nav-link dropdown-toggle' href='#' onClick={toggleDropdown} id='profileDropdown'>
              <Image src='/images/faces/face28.jpg' width={40} height={40} alt='profile' />
            </a>
            <div
