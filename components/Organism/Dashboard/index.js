              ...
              <div className='col-md-6 grid-margin stretch-card'>
                <div className='card tale-bg'>
                  <div className='card-people mt-auto'>
                    <Image src='/images/dashboard/people.svg' width={555} height={289} alt='people' />
                    {/* width="555" height="289" */}
                ...
                <div className='card'>
                  <div className='card-body'>
                    ...
                    <p className='font-weight-500'>
                      The total number of sessions within the date range. It is the period time a user is actively
                      ...
                      <table className='table table-borderless'>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <p className='mb-0'>
                                <span className='font-weight-bold mr-2'>65</span>(2.15%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p className='mb-0'>
                                <span className='font-weight-bold mr-2'>54</span>(3.25%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p className='mb-0'>
                                <span className='font-weight-bold mr-2'>22</span>(2.22%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p className='mb-0'>
                                <span className='font-weight-bold mr-2'>46</span>(3.27%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p className='mb-0'>
                                <span className='font-weight-bold mr-2'>17</span>(1.25%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td>
                              <p className='mb-0'>
                                <span className='font-weight-bold mr-2'>52</span>(3.11%)
                              </p>
                            </td>
                          ...
                          <tr>
                            ...
                            <td className='pb-0'>
                              <p className='mb-0'>
                                <span className='font-weight-bold mr-2'>25</span>(1.32%)
                              </p>
                            </td>
                ...
                <div className='card'>
                  <div className='card-body'>
                    ...
                    <ul className='icon-data-list'>
                      <li>
                        <div className='d-flex'>
                          <Image src='/images/faces/face1.jpg' width={40} height={40} alt='user' />
                          <div>
                      ...
                      <li>
                        <div className='d-flex'>
                          <Image src='/images/faces/face2.jpg' width={40} height={40} alt='user' />
                          <div>
                      ...
                      <li>
                        <div className='d-flex'>
                          <Image src='/images/faces/face3.jpg' width={40} height={40} alt='user' />
                          <div>
                      ...
                      <li>
                        <div className='d-flex'>
                          <Image src='/images/faces/face4.jpg' width={40} height={40} alt='user' />
                          <div>
                      ...
                      <li>
                        <div className='d-flex'>
                          <Image src='/images/faces/face5.jpg' width={40} height={40} alt='user' />
                          <div>
